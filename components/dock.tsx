...
export function Dock() {
  ...
  const items = [
    ...
    { icon: Github, label: "GitHub", href: "https://github.com/S4vad" },
    { icon: Linkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/savadk" },
    { icon: Twitter, label: "Twitter", href: "https://x.com/sava__d" },
    { icon: Mail, label: "Email", href: "mailto:1745savad@gmail.com" },
  ];
